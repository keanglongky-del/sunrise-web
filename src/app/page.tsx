...
export default function Home() {
  ...
  return (
    <div className="font-body text-bark bg-cream antialiased">
      ...
      {/* Hero — Full-width vine photo with bottom fade */}
      <section className="relative w-full">
        <div className="relative w-full h-[35vh] md:h-[40vh]">
          ...
          <div className="absolute inset-x-0 bottom-0 h-2/3 bg-gradient-to-t from-[#0D2B1E] via-[#0D2B1E]/40 to-transparent" />
          <div className="absolute top-5 md:top-7 left-1/2 -translate-x-1/2 w-14 h-14 md:w-16 md:h-16">
            <Image src="/images/logo-icon.png" alt="Sunrise" fill className="object-contain" />
          </div>
        </div>
      </section>

      {/* Continuous story — no hard separations */}
      <div className="bg-[#0D2B1E]">

        {/* Title + Intro */}
        <div className="text-center pt-14 md:pt-20 pb-10 md:pb-14 px-6 md:px-12">
          <div className="max-w-xl mx-auto">
            <h2 className="font-display text-[#D4B06A] text-4xl md:text-5xl lg:text-6xl tracking-[0.12em] mb-5 md:mb-6">
              QUALITY
            </h2>
            <div className="w-10 h-[1px] bg-[#D4B06A]/40 mx-auto mb-8 md:mb-10" />
        ...
        {/* Block 1 — Rooted in Kampot (photo left, text right on desktop) */}
        <div className="px-6 md:px-12 mb-12 md:mb-20">
          <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-6 md:gap-12">
            <div className="w-full md:w-1/2 relative aspect-[4/3] overflow-hidden">
              <Image src="/images/farm/photo-2020-05-25-11-28-51.jpg" alt="Close-up of healthy pepper vines" fill className="object-cover" sizes="(max-width: 768px) 100vw, 50vw" />
            </div>
            <div className="w-full md:w-1/2 flex flex-col justify-center">
              <h3 className="text-[#D4B06A] font-body font-semibold text-xs md:text-sm tracking-[0.1em] mb-3 md:mb-4">
                ROOTED IN KAMPOT
              </h3>
        ...
        {/* Block 2 — Certified Organic (photo right, text left on desktop — alternating) */}
        <div className="px-6 md:px-12 mb-12 md:mb-20">
          <div className="max-w-5xl mx-auto flex flex-col md:flex-row-reverse items-center gap-6 md:gap-12">
            <div className="w-full md:w-1/2 relative aspect-[4/3] overflow-hidden">
              <Image src="/images/farm/img-20230519-124423.jpg" alt="Sunrise farmer harvesting pepper" fill className="object-cover" sizes="(max-width: 768px) 100vw, 50vw" />
            </div>
            <div className="w-full md:w-1/2 flex flex-col justify-center">
              <h3 className="text-[#D4B06A] font-body font-semibold text-xs md:text-sm tracking-[0.1em] mb-3 md:mb-4">
        ...
        {/* Block 3 — Handcrafted Care (photo left, text right on desktop) */}
        <div className="px-6 md:px-12 mb-0 pb-16 md:pb-20">
          <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-6 md:gap-12">
            <div className="w-full md:w-1/2 relative aspect-[4/3] overflow-hidden">
              <Image src="/images/farm/photo-2020-05-25-11-28-42.jpg" alt="Hand sorting peppercorns" fill className="object-cover" sizes="(max-width: 768px) 100vw, 50vw" />
            </div>
            <div className="w-full md:w-1/2 flex flex-col justify-center">
              <h3 className="text-[#D4B06A] font-body font-semibold text-xs md:text-sm tracking-[0.1em] mb-3 md:mb-4">
                HANDCRAFTED CARE
      ...
      {/* Bottom Story Transition — Photo emerges from dark green */}
      <section className="relative w-full -mt-16 md:-mt-20">
        {/* Negative margin pulls photo under Block 3's green bg for seamless blend */}
        <div className="relative w-full h-[50vh] md:h-[60vh]">
          ...
          {/* Dark green-to-transparent gradient at top — blends from content */}
          <div className="absolute inset-x-0 top-0 h-1/3 bg-gradient-to-b from-[#0D2B1E] via-[#0D2B1E]/30 to-transparent" />
          {/* Quote overlay */}
          <div className="absolute inset-0 flex flex-col items-center justify-center px-8 md:px-16 text-center">
            <p className="text-[#F5F5F0] font-body text-sm md:text-base lg:text-lg leading-relaxed max-w-2xl mb-8 md:mb-10">
              &ldquo;From vine to harvest, every peppercorn reflects the care of our farmers and the character of Kampot.&rdquo;
            </p>
            <div className="w-14 h-14 md:w-16 md:h-16 relative opacity-80">
              <Image src="/images/logo-icon.png" alt="Sunrise" fill className="object-contain" />
            </div>
          </div>
        </div>
