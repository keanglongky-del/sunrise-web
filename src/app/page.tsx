  ...
  return (
    <div className="font-body text-bark bg-cream antialiased">
      ...
      <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
        {/* Full-bleed 3-color pepper background */}
        <Image src="/images/pepper-3colors.jpg" alt="Three Colors of Kampot Pepper" fill className="object-cover" priority />

        {/* Dark overlay for text readability */}
        <div className="absolute inset-0 bg-black/55" />

        {/* Small centered text — pepper background is the hero */}
        <div className="relative z-10 w-full max-w-2xl mx-auto px-6 md:px-10 text-center">
          <p className="text-white/90 text-[11px] sm:text-xs md:text-sm lg:text-base leading-relaxed font-light tracking-wide">
